...
@section('content')
    <div class="container-fluid px-4 py-5">
        ...
        <div class="rounded-5 p-5 mb-5 position-relative overflow-hidden animate__animated animate__fadeIn shadow-2xl"
            ...
            <div class="row align-items-center position-relative z-1">
                <div class="col-lg-8">
                    <div class="d-inline-flex align-items-center bg-white bg-opacity-10 backdrop-blur-md rounded-pill px-4 py-2 mb-4 border border-white border-opacity-20 shadow-sm">
                        <i class="bi bi-stars text-warning me-2 fs-5"></i>
                        <span class="small fw-black text-uppercase tracking-widest" style="letter-spacing: 2px;">{{ __('ELITE STUDENT PORTAL') }}</span>
                    </div>
                    <h1 class="display-3 fw-black mb-3 text-white" style="letter-spacing: -3px; line-height: 0.9;">
                        ...
                        <span class="text-warning position-relative">
                            {{ Auth::user()->name }}
                            <div class="position-absolute bottom-0 start-0 w-100" style="height: 8px; background: rgba(245,158,11,0.3); bottom: 10px; z-index: -1;"></div>
                        </span>!
                    </h1>
                ...
                <div class="col-lg-4 text-center text-lg-end mt-5 mt-lg-0">
                    ...
                    <div class="search-glass p-4 rounded-5 border border-white border-opacity-10 d-inline-block text-start shadow-2xl transform-hover transition-all">
                        <div class="d-flex align-items-center gap-4 mb-4">
                            ...
                            <div>
                                <div class="small text-white-50 fw-black text-uppercase tracking-wider" style="font-size: 0.65rem;">{{ __('Verified Member') }}</div>
                                <div class="fw-black text-white fs-5 text-truncate" style="max-width: 180px;">{{ Auth::user()->email }}</div>
                            </div>
                        </div>
                        <div class="vstack gap-2">
                            <a href="{{ route('jobs.index') }}"
                                class="btn btn-warning w-100 rounded-pill py-3 fw-black shadow-lg hover-lift d-flex align-items-center justify-content-center gap-2" style="color: #1e1b4b;">
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-12 col-sm-6 col-xl-3 animate__animated animate__fadeInUp" style="animation-delay: 0.1s;">
                <div class="advanced-stat-card h-100 p-4 rounded-5 border border-light bg-white shadow-soft transition-all hover-glow group position-relative overflow-hidden">
                    <div class="position-relative z-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="stat-icon-box rounded-4 d-flex align-items-center justify-content-center shadow-sm"
                                style="width: 54px; height: 54px; background: #eef2ff; color: #4f46e5;">
                                <i class="bi bi-briefcase-fill fs-3"></i>
                            </div>
                            <span class="badge rounded-pill bg-soft-warning text-warning fw-black small-caps px-3 py-2 border border-warning border-opacity-10">JOBS</span>
                        </div>
                        <h2 class="display-5 fw-black mb-1 text-dark">{{ $jobsCount }}</h2>
                        <p class="text-muted small fw-bold mb-0 text-uppercase tracking-widest">{{ __('Active Listings') }}</p>
                        <div class="mt-4 pt-3 border-top border-light d-flex justify-content-between align-items-center">
                            ...
                            <div class="rounded-circle bg-soft-primary p-2 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
            ...
            <div class="col-12 col-sm-6 col-xl-3 animate__animated animate__fadeInUp" style="animation-delay: 0.2s;">
                <div class="advanced-stat-card h-100 p-4 rounded-5 border border-light bg-white shadow-soft transition-all hover-glow group position-relative overflow-hidden">
                    <div class="position-relative z-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="stat-icon-box rounded-4 d-flex align-items-center justify-content-center shadow-sm"
                                style="width: 54px; height: 54px; background: #ecfdf5; color: #10b981;">
                                <i class="bi bi-lightning-charge-fill fs-3"></i>
                            </div>
                            <span class="badge rounded-pill bg-soft-success text-success fw-black small-caps px-3 py-2 border border-success border-opacity-10">LIVE</span>
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top border-light d-flex justify-content-between align-items-center">
                            ...
                            <div class="rounded-circle bg-soft-success p-2 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
            ...
            <div class="col-12 col-sm-6 col-xl-3 animate__animated animate__fadeInUp" style="animation-delay: 0.3s;">
                <div class="advanced-stat-card h-100 p-4 rounded-5 border border-light bg-white shadow-soft transition-all hover-glow group position-relative overflow-hidden">
                    <div class="position-relative z-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="stat-icon-box rounded-4 d-flex align-items-center justify-content-center shadow-sm"
                                style="width: 54px; height: 54px; background: #fffbeb; color: #f59e0b;">
                                <i class="bi bi-people-fill fs-3"></i>
                            </div>
                            <span class="badge rounded-pill bg-soft-warning text-warning fw-black small-caps px-3 py-2 border border-warning border-opacity-10">COMMUNITY</span>
                        </div>
                        ...
                        <div class="mt-4 pt-3 border-top border-light d-flex justify-content-between align-items-center">
                            ...
                            <div class="rounded-circle bg-soft-warning p-2 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
            ...
            <div class="col-12 col-sm-6 col-xl-3 animate__animated animate__fadeInUp" style="animation-delay: 0.4s;">
                <div class="advanced-stat-card h-100 p-4 rounded-5 border border-light bg-white shadow-soft transition-all hover-glow group position-relative overflow-hidden">
                    <div class="position-relative z-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="stat-icon-box rounded-4 d-flex align-items-center justify-content-center shadow-sm"
                                style="width: 54px; height: 54px; background: #f0f9ff; color: #0ea5e9;">
                                <i class="bi bi-activity fs-3"></i>
                            </div>
                            <span class="badge rounded-pill bg-soft-primary text-primary fw-black small-caps px-3 py-2 border border-primary border-opacity-10">PROGRESS</span>
                        </div>
                        <h2 class="display-5 fw-black mb-1 text-dark">{{ $pendingRequestsCount }}</h2>
                        <p class="text-muted small fw-bold mb-0 text-uppercase tracking-widest">{{ __('Pending Tasks') }}</p>
                        <div class="mt-4 pt-3 border-top border-light d-flex justify-content-between align-items-center">
            ...
            <div class="row g-4 mb-5 animate__animated animate__fadeInUp">
                <div class="col-12">
                    <div class="advanced-glass-card rounded-5 border-0 shadow-lg overflow-hidden position-relative">
                        <div class="position-absolute top-0 start-0 w-100 h-100 backdrop-blur-xl" style="background: rgba(255,255,255,0.4);"></div>
                        <div class="card-body p-4 position-relative z-1">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="d-flex align-items-center justify-content-center rounded-4 shadow-lg pulse-blue"
                                        style="width:50px;height:50px;background: linear-gradient(135deg, #1e1b4b 0%, #312e81 100%);color:white;">
                                ...
                                <a href="{{ route('notifications.index') }}"
                                    class="btn btn-dark rounded-pill px-4 py-2 fw-black small-caps shadow-sm hover-lift border-0" style="background: #1e1b4b;">
                                ...
                                <div class="notification-scroll-area pe-2" style="max-height: 280px; overflow-y: auto;">
                                    @foreach($recentNotifications as $notification)
                                        <div class="d-flex gap-4 p-3 mb-3 rounded-4 transition-all {{ !$notification->read ? 'bg-white shadow-md border-indigo-200' : 'bg-white bg-opacity-40 border-transparent' }} border"
                                            ...
                                            <div class="flex-shrink-0 d-flex align-items-center justify-content-center rounded-circle bg-light" style="width: 45px; height: 45px;">
                                                <i class="bi {{ \App\Services\NotificationService::getIcon($notification->type) }} fs-4 text-indigo-600"></i>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <p class="mb-1 {{ !$notification->read ? 'fw-black text-dark' : 'text-muted fw-bold' }} fs-6">
                                                        {{ $notification->title }}
                                                    </p>
                                                    <small class="text-muted fw-bold" style="font-size: 0.7rem;">{{ $notification->created_at->diffForHumans() }}</small>
                                                </div>
                                                <p class="text-muted small mb-0 line-clamp-1 opacity-75">{{ $notification->message }}</p>
                                            </div>
                                            @if(!$notification->read)
                                                <div class="d-flex align-items-center">
                                                    <form action="{{ route('notifications.read', $notification) }}" method="POST" class="m-0">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="btn btn-soft-warning rounded-circle p-2 d-flex align-items-center justify-content-center border-0" 
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-12 col-lg-8">
                ...
                <div
                    ...
                    <div class="card-header bg-white py-4 border-0 px-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-3">
                                <div class="bg-soft-success text-success rounded-4 d-flex align-items-center justify-content-center"
                                ...
                                <div>
                                    <h4 class="fw-black mb-0 text-dark position-relative d-inline-block">
                                        ...
                                        <div class="position-absolute bottom-0 start-0 w-50" style="height: 3px; background: #f59e0b; border-radius: 2px; bottom: -8px;"></div>
                                    </h4>
                                    <p class="text-muted small mt-2 mb-0 fw-medium">
                                        {{ __('Boost your skills with expert-led courses') }}</p>
                                </div>
                            </div>
                            <a href="{{ route('trainings.index') }}"
                                class="btn btn-sm rounded-pill px-4 fw-bold hover-lift border-0 shadow-sm" style="background: #fef3c7; color: #b45309;">
                        ...
                        @if(isset($availableTrainings) && $availableTrainings->count() > 0)
                            <div class="row g-4 row-cols-1 row-cols-md-2">
                                @foreach($availableTrainings as $training)
                                    <div class="col">
                                        <div class="advanced-glass-card h-100 p-4 rounded-5 border border-white border-opacity-10 transition-all hover-glow position-relative overflow-hidden group">
                                            ...
                                            <div class="position-relative z-1 h-100 d-flex flex-column">
                                                <div class="d-flex align-items-center gap-3 mb-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge rounded-pill bg-soft-warning text-warning small fw-bold">PRO LEVEL</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-auto">
                                                    <div class="d-flex align-items-center gap-4 mb-4 text-muted small fw-bold">
                                                        ...
                                                        <span><i class="bi bi-person-badge me-1 text-success"></i> {{ $training->mentor->name ?? __('Mentor') }}</span>
                                                        <span><i class="bi bi-bar-chart-fill me-1 text-info"></i> {{ __('Intermediate') }}</span>
                                                    </div>
                ...
                <div
                    ...
                    <div class="card-header bg-white py-4 border-0 px-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-3">
                                <div class="bg-soft-primary text-primary rounded-4 d-flex align-items-center justify-content-center"
                                    style="width: 48px; height: 48px;">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mt-2 mb-0 fw-medium">
                                        {{ __('Top positions matching your profile') }}</p>
                                </div>
                            </div>
                            <a href="{{ route('jobs.index') }}"
                                class="btn btn-sm rounded-pill px-4 fw-bold hover-lift border-0 shadow-sm" style="background: #e0e7ff; color: #1e1b4b;">
                        ...
                        <div class="vstack gap-4">
                            @if(isset($recentJobs) && $recentJobs->count() > 0)
                                @foreach($recentJobs as $job)
                                    <div class="advanced-job-card p-4 rounded-5 border border-light bg-white shadow-sm transition-all hover-glow group position-relative overflow-hidden">
                                        ...
                                        <div class="row align-items-center position-relative z-1">
                                                ...
                                                <div class="d-flex align-items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex gap-3 mt-2">
                                                            <span class="small fw-bold text-muted"><i class="bi bi-building me-1"></i> {{ $job->company ?? 'Company' }}</span>
                                                            <span class="small fw-bold text-muted"><i class="bi bi-geo-alt-fill me-1 text-danger"></i> {{ $job->location ?? 'Remote' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5 text-md-end mt-4 mt-md-0">
                                                <div class="d-flex align-items-center justify-content-md-end gap-3">
                                                    ...
                                                    @if($application)
                                                        <span class="badge rounded-pill px-4 py-3 border {{ $application->status == 'approved' ? 'bg-soft-success text-success border-success' : ($application->status == 'rejected' ? 'bg-soft-danger text-danger border-danger' : 'bg-soft-warning text-warning border-warning') }} fw-bold text-uppercase tracking-wider small">
                                                        ...
                                                        @if($application->status == 'pending')
                                                            <form action="{{ route('job_applications.destroy', $application) }}"
                                                                ...
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="btn btn-outline-danger rounded-circle p-2 border-0 hover-lift" title="{{ __('Cancel') }}">
                                                                    <i class="bi bi-trash3-fill fs-5"></i>
                                                                </button>
                                                            </form>
                                                        @endif
                                                    @else
                                                        <span class="badge bg-light text-dark fw-bold px-3 py-2 rounded-pill small me-2">$2K - 5K</span>
                                                        <form action="{{ route('job_applications.store', $job) }}" method="POST">
                                                            @csrf
                                                            <button class="btn btn-primary rounded-pill px-5 py-3 fw-black shadow-lg hover-lift text-white border-0" style="background: #1e1b4b; letter-spacing: 1px;">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="advanced-glass-card p-4 mb-4 rounded-5 border-0 shadow-lg position-relative overflow-hidden transition-all hover-translate-y-n2">
                    ...
                    <div class="position-relative z-1 text-center py-2">
                        <div class="position-relative d-inline-block mb-4">
                            ...
                            <svg class="profile-progress" width="130" height="130" viewBox="0 0 120 120">
                                <circle class="progress-ring-bg" cx="60" cy="60" r="54" fill="transparent" stroke="rgba(0,0,0,0.03)" stroke-width="6" />
                        ...
                        <div class="d-flex justify-content-center gap-3 mb-4">
                            <div class="px-3 py-2 bg-white bg-opacity-50 rounded-pill border border-light shadow-sm">
                                <span class="badge rounded-circle bg-indigo-600 p-1 me-2" style="width:8px;height:8px;display:inline-block"></span>
                                <span class="small fw-black text-indigo-900 text-uppercase tracking-wider">{{ __(ucfirst(Auth::user()->role ?? 'Student')) }}</span>
                            </div>
                ...
                <div class="advanced-glass-card p-4 mb-4 rounded-5 border-0 shadow-lg" id="mentorship-requests-section">
                    <div class="d-flex align-items-center justify-content-between mb-4 pb-2 border-bottom border-light">
                        <h6 class="fw-black mb-0 text-dark d-flex align-items-center gap-2">
                            <div class="p-2 bg-soft-warning rounded-3"><i class="bi bi-person-check-fill text-warning fs-5"></i></div>
                            {{ __('Mentorship Flow') }}
                        </h6>
                        <span class="badge bg-indigo-950 text-white rounded-pill px-3 py-2 small fw-black shadow-sm">{{ count($myRequests) }}</span>
                    </div>

                    @if($myRequests && count($myRequests) > 0)
                        <div class="vstack gap-3">
                            @foreach($myRequests->take(3) as $req)
                                <div class="p-3 bg-white bg-opacity-40 rounded-4 border border-white border-opacity-50 shadow-sm transition-all hover-translate-x-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="position-relative">
                                                <img src="https://ui-avatars.com/api/?name={{ urlencode($req->mentor->name ?? 'M') }}&background=1e1b4b&color=fff&size=40&bold=true"
                                                    class="rounded-circle border border-white border-2 shadow-sm" width="40" height="40">
                                                <div class="position-absolute bottom-0 end-0 bg-warning rounded-circle" style="width:12px; height:12px; border: 2px solid white"></div>
                                            </div>
                                            <div>
                                                <h6 class="small fw-black mb-0 text-dark">{{ $req->mentor->name ?? __('Unknown') }}</h6>
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            @endphp
                                            <span class="badge rounded-pill px-2 py-1 small fw-black text-uppercase" style="background: {{ $statusColor }}20; color: {{ $statusColor }}; font-size: 0.6rem;">{{ __($st) }}</span>
                    ...
                    @else
                        <div class="text-center py-5 rounded-4 border border-dashed border-light">
                            ...
                            <p class="text-muted small fw-bold mb-0 text-uppercase tracking-tighter">{{ __('No Mentorship Activity') }}</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="advanced-glass-card p-4 mb-4 rounded-5 border-0 shadow-lg">
                    <div class="d-flex align-items-center justify-content-between mb-4 pb-2 border-bottom border-light">
                        <h6 class="fw-black mb-0 text-dark d-flex align-items-center gap-2">
                            <div class="p-2 bg-soft-info rounded-3"><i class="bi bi-play-circle-fill text-info fs-5"></i></div>
                            {{ __('My Academy') }}
                        </h6>
                    </div>
                        ...
                        <div class="vstack gap-3">
                            @foreach($myTrainings->take(2) as $enrollment)
                                <div class="p-3 bg-white bg-opacity-40 rounded-4 border border-white border-opacity-50">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="progress flex-grow-1 shadow-inner" style="height: 6px; border-radius: 10px; background: rgba(0,0,0,0.05);">
                                            <div class="progress-bar bg-info rounded-pill"
                                                style="width: {{ $enrollment->status == 'completed' ? '100%' : ($enrollment->status == 'enrolled' ? '45%' : '10%') }}">
                                            </div>
                                        </div>
                                        <span class="small fw-black text-indigo-900" style="font-size: 0.65rem;">{{ $enrollment->status == 'completed' ? '100%' : '45%' }}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                    @else
                        <div class="text-center py-5 rounded-4 border border-dashed border-light">
                            ...
                            <p class="text-muted small fw-bold mb-0 text-uppercase tracking-tighter">{{ __('Enroll in Your First Course') }}</p>
                        </div>
                    @endif
                </div>

                <!-- Black-Gold Pro Tips -->
                    <div class="card border-0 shadow-2xl rounded-5 p-4 bg-indigo-950 text-white overflow-hidden position-relative">
                        <div class="position-relative z-1">
                        ...
                        <ul class="small list-unstyled mb-0 vstack gap-3">
                            <li class="d-flex align-items-start gap-3">
                                ...
                                <span class="fw-medium text-white-50"><strong class="text-white">{{ __('Verify Identity:') }}</strong> {{ __('Verified users get 40% more mentor responses.') }}</span>
                            </li>
                            <li class="d-flex align-items-start gap-3">
                                <i class="bi bi-patch-check-fill text-warning mt-1"></i>
                                <span class="fw-medium text-white-50"><strong class="text-white">{{ __('Skill Gaps:') }}</strong> {{ __('Check training modules to match job requirements.') }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <style>
        ...
        .small-caps { text-transform: uppercase; font-size: 0.7rem; letter-spacing: 1px; }
        ...
        .pulse-gold { animation: gold-glow 3s infinite; }
        .pulse-blue { animation: blue-glow 3s infinite; }
        ...
        .bg-indigo-950 { background-color: #0c0a2d; }
        .text-indigo-900 { color: #1e1b4b; }
        .text-indigo-600 { color: #4f46e5; }
        .bg-soft-primary { background: rgba(79, 70, 229, 0.08); }
        ...
        /* Stats Styling */
        .stat-icon-box { transition: all 0.3s ease; }
        .group:hover .stat-icon-box { transform: scale(1.1) rotate(5deg); }

        /* Profile Ring */
        .profile-progress { transform: rotate(-90deg); }
        .progress-ring-fill { transition: stroke-dashoffset 0.8s ease-in-out; }
